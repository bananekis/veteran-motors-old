...
export default function SoldPage() {
	const soldCars = cars.filter(
		(car) => car.categories.includes("sale") && car.available === false
	);
	...
	return (
		<div className="pt-32 pb-16">
			<div className="container-vintage">
				<ArtDecoHeading centered>PRODANÁ AUTA</ArtDecoHeading>

				<div className="mb-16 text-center">
					<p className="font-cormorant text-2xl text-brown">
						Prohlédněte si naši historii prodaných vozů. Každý vůz
						byl pečlivě vybrán a prodán spokojenému zákazníkovi.
					</p>
				</div>
					...
					>
						<div className="p-8 bg-cream">
							...
							<ul className="grid grid-cols-1 md:grid-cols-2 gap-6">
								{[
									"Více než 100 prodaných vozů",
									"Spokojení zákazníci",
									"Garance kvality",
									"Profesionální servis",
									"Kompletní dokumentace",
									"Záruka na prodané vozy",
								].map((service, index) => (
									<motion.li
										key={index}
										initial={{
						...
						<div className="art-deco-border">
							<div className="p-6 bg-cream">
								<div className="space-y-4 font-montserrat">
									<p>
										Každý vůz, který prodáváme, prochází
										důkladnou kontrolou:
									</p>

									<ul className="list-disc pl-6 space-y-4">
										<li>
											Kompletní servisní prohlídka a
											údržba
										</li>
										<li>
											Kontrola technického stavu a
											bezpečnosti
										</li>
										<li>Důkladná kontrola historie vozu</li>
										<li>Záruka na technický stav</li>
										<li>
											Kompletní dokumentace a servisní
											knížka
										</li>
									</ul>
								</div>
				...
				<section ref={galleryRef} className="mb-24">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 max-w-7xl mx-auto">
						{soldCars.slice(0, 3).map((car, index) => (
							<div
								key={car.id}
